...
int main() {                                                                                                // สร้างฟังก์ชั่นหลักของโปรแกรม เพื่อเป็นจุดเริ่มต้นการทำงานเมื่อรันโปรแกรม
    ...
    printf("Enter membership level (1-4): ");                                                               // แสดงให้ผู้ใช้งานกรอกค่าระดับสมาชิก
    scanf("%d", &level);                                                                                    // รับค่าจากผู้ใช้

    switch(level) {                                                                                         // สร้างเงื่อนไนตรวจสอบด้วย switch-case โดยจะจำแนกเป็นแต่ละกรณี โดยที่
        case 1:                                                                                             // ในกรณีที่ Level มีค่าเป็น 1
            printf("Silver Member: 5%% discount\n");                                                        // แสดงผลลัพธ์ว่า Silver Member: 5% discount
            break;                                                                                          // จบการทำงานของ Switch case
        case 2:                                                                                             // ในกรณีที่ Level มีค่าเป็น 2
            printf("Gold Member: 10%% discount + Reward points\n");                                         // แสดงผลลัพธ์ว่า Gold Member: 10%% discount + Reward points
            break;                                                                                          // จบการทำงานของ Switch case
        case 3:                                                                                             // ในกรณีที่ Level มีค่าเป็น 3
            ...
            break;                                                                                          // จบการทำงานของ Switch case
        case 4:                                                                                             // ในกรณีที่ Level มีค่าเป็น 4
            ...
            break;                                                                                          // จบการทำงานของ Switch case
        default:                                                                                            // ถ้าหากไม่ตรงกับกรณีใดเลย
